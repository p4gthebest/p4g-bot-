...
exports.run = (client, message, args, ops, prefix) => {
  ...
  let Kuser = message.guild.member(message.mentions.users.first() || message.guild.members.get(args[0]));
    ...
    if(!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send("Sorry, you don't have permissions");
    if(Kuser.hasPermission("ADMINISTRATOR")) return message.channel.send("Sorry, you can't ban this member");
    ...
    .setDescription(`
  ● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ●
  ❤️**${message.author}** bans **${Kuser}** for **${Kreason}** in **${userCreated[0]}** **${userCreated[1]}** **${userCreated[2]}** **${userCreated[3]}** 
  ● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ●
  `)
    .setTimestamp()

    message.guild.member(Kuser).ban(Kreason);
    message.channel.send(`**${Kuser}**Has Been banned`);
